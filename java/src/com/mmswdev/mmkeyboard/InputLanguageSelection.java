...
public class InputLanguageSelection extends PreferenceActivity {
    private static final String TAG = "MMKeyboardILS";
    ...
    // Languages which should allow non-letter characters for auto-completion
    public static final Set<String> NONLETTER_LANGUAGES = new HashSet<String>();
    static {
        NONLETTER_LANGUAGES.add("my");
    }

    // Languages which should not have voice input
    public static final Set<String> NONVOICE_LANGUAGES = new HashSet<String>();
    static {
