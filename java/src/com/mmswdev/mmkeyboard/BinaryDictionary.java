...
public class BinaryDictionary extends Dictionary {
    ...
    static {
        try {
            System.loadLibrary("jni_mmkeyboard");
            Log.i("MMKeyboard", "loaded jni_mmkeyboard");
        } catch (UnsatisfiedLinkError ule) {
            Log.e("BinaryDictionary", "Could not load native library jni_mmkeyboard");
        }
    }
    ...
    private final void loadDictionary(InputStream[] is) {
        try {
            ...
            if (mDictLength > 10000) Log.i("MMKeyboard", "Loaded dictionary, len=" + mDictLength);
        } catch (IOException e) {
