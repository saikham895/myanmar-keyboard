...
public class PluginManager extends BroadcastReceiver {
    private static String TAG = "MMKeyboard";
    ...
    private static String MMKEYBOARD_INTENT_DICT = "com.mmswdev.mmkeyboard.DICT";
    ...
    static private class DictPluginSpecMMKeyboard
            extends DictPluginSpecBase {

        int mRawId;

        public DictPluginSpecMMKeyboard(String pkg, int rawId) {
            mPackageName = pkg;
            mRawId = rawId;
        }
        ...
        InputStream[] getStreams(Resources res) {
            ...
            InputStream in = res.openRawResource(mRawId);
            return new InputStream[] {in};
        }
    }
    @Override
    ...
    static void getMMKeyboardDictionaries(PackageManager packageManager) {
        Intent dictIntent = new Intent(MMKEYBOARD_INTENT_DICT);
        ...
        for (ResolveInfo ri : dictPacks) {
            ...
            try {
                            ...
                            if (tag != null) {
                                if (tag.equals("Dictionary")) {
                                    ...
                                    if (type == null || type.equals("raw") || type.equals("binary")) {
                                        rawId = res.getIdentifier("words", "raw", pkgName);
                                    } else {
                ...
                if (rawId == 0 || lang == null) continue;
                DictPluginSpec spec = new DictPluginSpecMMKeyboard(pkgName, rawId);
    ...
    static void getPluginDictionaries(Context context) {
        mPluginDicts.clear();
        PackageManager packageManager = context.getPackageManager();
        getMMKeyboardDictionaries(packageManager);
