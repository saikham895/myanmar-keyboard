...
import com.mmswdev.mmkeyboard.LatinIMEUtil.RingCharBuffer;
...
public class LatinIME extends InputMethodService implements
    ...
    private static final String TAG = "MMKeyboardIME";
...
//    private ContactsDictionary mContactsDictionary;
    ...
    public void onCreate() {
        Log.i("MMKeyboard", "onCreate(), os.version=" + System.getProperty("os.version"));
    ...
    private void setNotification(boolean visible) {
    	final String ACTION = "com.mmswdev.mmkeyboard.SHOW";
        final int ID = 1;
        ...
        if (visible && mNotificationReceiver == null) {
            ...
            String title = "Show Myanmar Keyboard";
...
//        }
    ...
    public void onConfigurationChanged(Configuration conf) {
        Log.i("MMKeyboard", "onConfigurationChanged()");
    ...
    public void onStartInputView(EditorInfo attribute, boolean restarting) {
        ...
        //Log.i("MMKeyboard", "onStartInputView " + attribute + ", inputType= " + Integer.toHexString(attribute.inputType) + ", restarting=" + restarting);
...
//                );
    ...
    private void reloadKeyboards() {
        ...
        if (mKeyboardSwitcher.getInputView() != null
            ...
            mKeyboardSwitcher.setVoiceMode(mEnableVoice && mEnableVoiceButton && mLanguageSwitcher.allowVoiceInput(),
                    mVoiceOnPrimary);
        }
        updateKeyboardOptions();
        mKeyboardSwitcher.makeKeyboards(true);
...
//                .obtainMessage(MSG_UPDATE_SHIFT_STATE), 300);
    ...
    private void handleCharacter(int primaryCode, int[] keyCodes) {
        ...
        if ((isAlphabet(primaryCode) || mLanguageSwitcher.allowNonAlphabet()) && isPredictionOn()
    ...
    void toggleLanguage(boolean reset, boolean next) {
        ...
        mKeyboardSwitcher.setKeyboardMode(currentKeyboardMode, 0,
                mEnableVoiceButton && mEnableVoice && mLanguageSwitcher.allowVoiceInput());
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
            String key) {
        Log.i("MMKeyboard", "onSharedPreferenceChanged()");
    ...
    private void loadSettings() {
        ...
        if (VOICE_INSTALLED) {
            ...
            if (mKeyboardSwitcher != null
                ...
                mKeyboardSwitcher.setVoiceMode(enableVoice && mLanguageSwitcher.allowVoiceInput(), voiceOnPrimary);
            }
    ...
    static int getPrefInt(SharedPreferences prefs, String prefName, int defVal) {
        ...
        //Log.i("MMKeyboard", "getPrefInt " + prefName + " = " + prefVal + ", default " + defVal);
